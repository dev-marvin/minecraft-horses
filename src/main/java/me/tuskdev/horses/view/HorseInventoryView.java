    ...
    protected void onRender(ViewContext context) {
        ...
        context.slot(13, new ItemBuilder(Material.SKULL_ITEM, 1, "§eInfo:")
                ...
                .lore(
                        ...
                        "",
                        String.format("  §eJump: §a0.70 §7+ §8(§b%s.00§8) [§7LvL: §d%s§8) (§7Actual: %,.2f§8)", customHorse.getJump(), customHorse.getJump(), horse.getJumpStrength()),
                        String.format("  §eSpeed: §a0.35 §7+ §8(§b%s§8) [§7LvL: §d%s§8) (§7Actual: %,.2f§8)", customHorse.getSpeed()*0.05, customHorse.getSpeed(), horse.getAttribute(Attribute.GENERIC_MOVEMENT_SPEED).getValue()),
                        String.format("  §eHealth: §a20.00 §7+ §8(§b%s§8) [§7LvL: §d%s§8) (§7Actual: %,.2f§8)", customHorse.getLife()*2.00, customHorse.getLife(), horse.getMaxHealth()),
